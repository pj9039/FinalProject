...
<?
	...
	$shcode = ($_POST['shcode']) ? $_POST['shcode'] : $_GET['shcode'];
...
<table style="width:1200">
	...
	?>
					<td style="border:1px solid #bcbcbc;"><a href="result.php?shcode=<?=$shcode?>&price1=<?=$price1?>&price2=<?=$price2?>&chkGraph=<?=$img_v?>"><? echo $row["shcode"] ?></td>
...
<?//첫 페이지
	...
	<?}else{?>
				<font size="2"><a href="P_result.php?page=&list=<?=$list?>&shcode=<?=$shcode?>&price1=<?=$price1?>&price2=<?=$price2?>" style="text-decoration:none">[처음] </a></font>
		<?}
	...
	if($block <= 1){?>
		<font> </font>
	<?}else{?>
			<font size="2"><a href="P_result.php?page=<?=$b_start_page-1?>&list=<?=$list?>&shcode=<?=$shcode?>&price1=<?=$price1?>&price2=<?=$price2?>" style="text-decoration:none">[이전] </a></font>
	<?}
	...
	for($j=$b_start_page; $j<=$b_end_page; $j++){
		...
		<?}else{?>
					<font size="2"><a href="P_result.php?page=<?=$j?>&list=<?=$list?>&shcode=<?=$shcode?>&price1=<?=$price1?>&price2=<?=$price2?>" style="text-decoration:none"><?=$j?> </a></font>
		<?}
	}
	...
	if($block>=$total_block){?>
		<font>  </font>
	<?}else{?>
				<font size="2"><a href="P_result.php?page=<?=$b_end_page+1?>&list=<?=$list?>&shcode=<?=$shcode?>&price1=<?=$price1?>&price2=<?=$price2?>" style="text-decoration:none">[다음] </a></font>
	<?}
	...
	<?}else{?>
				<font size="2"><a href="P_result.php?page=<?=$total_page?>&list=<?=$list?>&shcode=<?=$shcode?>&price1=<?=$price1?>&price2=<?=$price2?>" style="text-decoration:none">[마지막]</a></font>
	<?}?>
			</td>
		</tr>
	</table>
	...
	?>
	<h2>그래프</h2>
	<img src="./python/Stock/Pattern/temp/20170419_000020_0_0_temp.png">
	</form>
</center>
</body>
</HTML>
